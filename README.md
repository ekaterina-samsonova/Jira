...
1. Скачайте файл **`dist/Mindbox-to-SFMC-Converter-v3-Sanofi.html`** (новая версия с фиолетовой шапкой Sanofi)
2. Сохраните его на компьютер (например, на Рабочий стол)
3. Откройте **двойным кликом** — откроется в браузере (Chrome, Edge, Firefox)
4. Убедитесь, что видите **фиолетовую шапку sanofi** и надпись **«Версия 3.0 — обновлённый интерфейс»**
5. Загрузите HTML Mindbox, заполните параметры, нажмите «Конвертировать» и «Скачать SFMC HTML»

> Если открывается старый синий интерфейс — вы открыли старый файл. Скачайте заново файл с **`v3-Sanofi`** в названии.
